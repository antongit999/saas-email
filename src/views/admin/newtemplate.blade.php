...
<div class='row-fluid section-header'>
	<div class='title'>
		Create a new HTML Template to house your messages
	</div>

	<div class='btn-group'>
		<a class="btn btn-default" role="button" href="{{ AdminURL::route('email.getindex') }}">Go Back to Templates</a>
	</div>
</div>
...
<div class='row-fluid'>
	<div class='span8 box'>
		...
		<div class='box-content'>
			{{ Form::open(array('class' => 'form','url' => AdminURL::route('email.postnewtemplate'), 'method' => 'post'))  }}
			{{ Form::token() }}
			<fieldset>
				<div class='row-fluid'>
					<div class='span12'>
						<div class='control-group'>
							...
							<div class='controls'>
								{{ Form::text('title', Input::old('title'), array('placeholder' => 'ex: Christmas Card', 'class' => 'span6')) }}
							</div><!--/.controls-->
						</div><!--/.control-group-->
						...
						<div class='control-group'>
							...
							<div class='controls'>
								<textarea name="body" id='inputTextArea1' class='span12' placeholder='Text for your message' rows='32'></textarea>
							</div><!--/.controls-->
						</div><!--/.control-group-->
					</div><!--/.span8-->
				</div><!--/.row-fluid-->
