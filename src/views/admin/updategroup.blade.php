...
<div class='row-fluid'>
	<div class='span8 box'>
		...
		<div class='box-content'>
			{{ Form::open(array('class' => 'form','url' => AdminURL::route('email.postupdategroup', $grp->id), 'method' => 'post'))  }}
			{{ Form::token() }}
			<fieldset>
				<div class='row-fluid'>
					<div class='span12'>
						<div class='control-group'>
							...
							<div class='controls'>
								{{ Form::text('name', $grp->name, array('placeholder' => 'ex: Users', 'class' => 'span6')) }}
							</div><!--/.controls-->
						</div><!--/.control-group-->
						...
						<div class='control-group'>
							...
							<div class='controls'>
								{{ Form::textArea('description', $grp->description, array('class' => 'span12', 'rows'=>32)) }}
							</div><!--/.controls-->
						</div><!--/.control-group-->
